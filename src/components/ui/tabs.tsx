...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-white/5 p-1 text-muted-foreground backdrop-blur",
      className
    )}
    {...props}
  />
